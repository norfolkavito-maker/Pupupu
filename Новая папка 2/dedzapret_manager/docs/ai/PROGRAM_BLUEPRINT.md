...
При первом запуске (через `run.bat` или собранный исполнимый файл) программа выполняет preflight‑проверку:
...
1. **Stage 0 — Документация и правила.** Создать основные документы: `PRODUCT_OVERVIEW.md`, `PROGRAM_BLUEPRINT.md`, `OPERATIONS_AND_QOL_SPEC.md`, `RUNTIME_SOURCE_POLICY.md`, `AGENT_RULES_RUNTIME_REBUILD.md`.
